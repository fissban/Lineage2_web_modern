class Rankings
{
    ...
    async getPvp()
    {
        ...
        let clases = await $.getJSON("../json/clases.json");
        ...
        json.forEach(character =>
        {
            html +=
                `
                    <tr>
                        <td class="td-ranking"><img src="../img/texturesGame/l2ui_ch3/ps_sizecontrol2.png" alt="icon position">${pos}</td>
    ...
    async getCastles()
    {
        ...
        json.forEach(castle =>
        {
            html +=
                `
                    <tr>
                        <td class="td-ranking"><img src="../img/texturesGame/l2ui_ch3/ps_sizecontrol2.png" alt="icon position"></td>
